        ...
        <br><br><br><br><br><br><br><br>
            <div id="maincontent">
                ...
                <div class="boxinabox">
                    ...
                    <center><h1>Website Links</h1></center>
                    <center><h4> 
                    <?php
                    while ($row = $result->fetch_assoc()) {
                    echo "<li>" .htmlspecialchars($row['Links']) . "</li>";
                    }
                    ?>
                ...
                <div class="triplerectinside">
                    ...
                    <?php
                    $pic="/SFMFinal/images/";
                    $result = $con->query("SELECT * FROM upload");
                    if ($result) {
                        if (mysqli_num_rows($result) > 0) {
                            while ($row = mysqli_fetch_assoc($result)) {
                                echo "<img src='/SFMFinal/images/" . $row['FileToUpload'] . "'>";
                            }
                        }
                    }
                    ?> 
                    ...
                    <div class="rectanglesmallboxes">
                    <div class=uploadimage>
                    <a href="ViewProfile.php"><h1>Back To View Profile</h1></a>
                    </div>
                    </div>
                    <br><br>
                    <div class="rectanglesmallboxes">
